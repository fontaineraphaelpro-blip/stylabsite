...
const urls = [
  ...
  ...SHOPIFY_COMPARE.map(c => entry(`/compare/${c.slug}.html`, { priority: '0.8' })),
  ...API_COMPARE.map(c => entry(`/compare/api/${c.slug}.html`, { priority: '0.7' })),
  entry('/fr/compare/', { changefreq: 'monthly', priority: '0.8' }),
  ...SHOPIFY_COMPARE.map(c => entry(`/fr/compare/${c.slug}.html`, { priority: '0.75' })),
  ...API_COMPARE.map(c => entry(`/fr/compare/api/${c.slug}.html`, { priority: '0.7' })),
  entry('/solutions/', { changefreq: 'monthly', priority: '0.8' }),
  ...SOLUTIONS.map(s => entry(`/solutions/${s.slug}.html`, { priority: '0.7' })),
  entry('/fr/solutions/', { changefreq: 'monthly', priority: '0.75' }),
  ...SOLUTIONS.map(s => entry(`/fr/solutions/${s.slug}.html`, { priority: '0.65' })),
  entry('/resources/', { changefreq: 'weekly', priority: '0.8' }),
  entry('/resources/free-tools.html', { priority: '0.75' }),
  entry('/resources/documentation.html', { priority: '0.7' }),
  entry('/resources/changelog.html', { changefreq: 'weekly', priority: '0.6' }),
  entry('/resources/blog/', { changefreq: 'weekly', priority: '0.7' }),
  ...BLOG_POSTS.map(p => entry(`/resources/blog/${p.slug}.html`, { priority: '0.6' })),
  entry('/fr/resources/', { changefreq: 'weekly', priority: '0.75' }),
  entry('/fr/resources/free-tools.html', { priority: '0.7' }),
  entry('/fr/resources/documentation.html', { priority: '0.65' }),
  entry('/fr/resources/changelog.html', { changefreq: 'weekly', priority: '0.55' }),
  entry('/fr/resources/blog/', { changefreq: 'weekly', priority: '0.65' }),
  ...BLOG_POSTS.map(p => entry(`/fr/resources/blog/${p.slug}.html`, { priority: '0.55' })),
  entry('/contact.html', { priority: '0.6' }),
