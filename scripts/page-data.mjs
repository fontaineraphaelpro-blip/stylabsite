...
export const BLOG_POSTS = [
  {
    ...
    title: {
      en: 'Reduce purchase hesitation with virtual try-on on Shopify',
      fr: 'Réduire l\'hésitation d\'achat avec l\'essayage virtuel Shopify',
    },
    excerpt: {
      en: 'Spot hesitation on your PDP, pick the right SKUs, and launch try-on on five products — a practical rollout guide for Shopify apparel merchants.',
      fr: 'Repérez l\'hésitation sur votre PDP, choisissez les bons SKU et lancez l\'essayage sur cinq produits — guide pratique marchands apparel.',
    },
    date: 'May 15, 2026',
    dateISO: '2026-05-15',
    summary: {
...
<li><a href="{{DEMO_LINK}}">Démo live</a></li>
  ...
  },
  {
    ...
    excerpt: {
      en: 'Most try-on sessions happen on phones — placement, load time, and upload UX matter more than desktop. Checklist for Shopify apparel merchants.',
      fr: 'La majorité des sessions essayage sont sur mobile — placement, chargement et upload comptent plus que le desktop. Checklist marchands apparel.',
    },
    date: 'May 18, 2026',
    dateISO: '2026-05-18',
    summary: {
...
<li><a href="{{DEMO_LINK}}">Démo live sur mobile</a></li>
  ...
  },
  {
    ...
    title: {
      en: 'How to choose a virtual try-on plan for Shopify',
      fr: 'Choisir un plan d\'essayage virtuel pour Shopify',
    },
    excerpt: {
      en: 'Estimate monthly try-on volume from PDP traffic, pick Free vs Starter vs Growth, and know when to upgrade — Stylab credits and ROI calculator.',
      fr: 'Estimez le volume mensuel depuis le trafic PDP, choisissez Free vs Starter vs Growth et sachez quand upgrader — crédits Stylab et calculateur ROI.',
    },
    date: 'May 20, 2026',
    dateISO: '2026-05-20',
    summary: {
...
<li><a href="../free-tools.html">Outils gratuits & calculateur ROI</a></li>
  ...
  },
  {
    ...
    title: {
      en: 'Shopper photo privacy for Shopify virtual try-on',
      fr: 'Confidentialité des photos clients — essayage virtuel Shopify',
    },
    excerpt: {
      en: 'What happens to customer photos during AI try-on, what to tell shoppers on your PDP, and how Stylab handles retention, GDPR, and uninstall.',
      fr: 'Que deviennent les photos clients pendant l\'essayage IA, quoi dire sur la PDP, et comment Stylab gère rétention, RGPD et désinstallation.',
    },
    date: 'May 17, 2026',
    dateISO: '2026-05-17',
    summary: {
