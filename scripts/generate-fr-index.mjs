...
const replacements = [
  ...
  ['Let shoppers see themselves wearing your products before they buy.', 'Permettez à vos clients de se voir porter vos produits avant d\'acheter.'],
  ['<span class="text-gradient">AI try-on</span> for Shopify apparel brands', '<span class="text-gradient">Essayage IA</span> pour marques apparel Shopify'],
  ...
  // Conversion funnel
  ['Try live demo — 30 sec', 'Essayer la démo — 30 sec'],
  ['Install free on Shopify', 'Installer gratuit sur Shopify'],
  ['<strong>Free plan</strong> · 50 try-ons/mo · No credit card · Live in ~5 min', '<strong>Plan gratuit</strong> · 50 essayages/mo · Sans CB · En ligne en ~5 min'],
  ['Your path to try-on', 'Votre parcours essayage'],
  ['See AI result', 'Voir le résultat IA'],
  ['Install free', 'Installer gratuit'],
  ['Try demo now', 'Essayer la démo'],
  ['Finish demo', 'Finir la démo'],
  ['<em>77.8%</em> try-on → add-to-cart on pilot store · Your turn in <em>~30 seconds</em>', '<em>77,8&nbsp;%</em> essayage → panier (pilote) · À vous en <em>~30 secondes</em>'],
  ['Click <strong>Try it on</strong> on the product below', 'Cliquez sur <strong>Essayer</strong> sur le produit ci-dessous'],
  ['Upload a photo — <strong>not stored</strong> in our database', 'Uploadez une photo — <strong>non stockée</strong> dans notre base'],
  ['See yourself in the jersey — <strong>then install free</strong>', 'Voyez-vous dans le maillot — <strong>puis installez gratuit</strong>'],
  ['That&rsquo;s what your shoppers will see on your store', 'C\'est ce que vos clients verront sur votre boutique'],
  ['Install Stylab free — 50 try-ons/mo included. Same widget, live on Shopify in about 5 minutes.', 'Installez Stylab gratuit — 50 essayages/mo inclus. Même widget, en ligne sur Shopify en ~5 minutes.'],
  ['Session completion rate', 'Taux de complétion session'],
  ['Start free — 50 try-ons/mo', 'Gratuit — 50 essayages/mo'],
  ['Shoppers see themselves wearing it', 'Le client se voit porter le vêtement'],
  ['Get started free', 'Commencer gratuit'],
  ['Install free now', 'Installer gratuit'],
  ['Before you go', 'Avant de partir'],
  ['See it on yourself in 30 seconds', 'Voyez-vous en 30 secondes'],
  ['Pilot stores saw <strong>77.8% try-on → add-to-cart</strong>. Try the live demo — same widget your shoppers get on Shopify product pages.', 'Les boutiques pilotes ont vu <strong>77,8&nbsp;% essayage → panier</strong>. Essayez la démo — même widget que vos clients sur Shopify.'],
  ['Install free — 50 try-ons/mo', 'Installer gratuit — 50 essayages/mo'],
  // Discover section
