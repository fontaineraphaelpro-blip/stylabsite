...
const DEMO_URL = {
  en: "remadeicons.shop/products/shadow-stripe-jersey",
  fr: "remadeicons.shop/products/maillot-shadow-stripe",
};
      ...
      >
        <div className="demo-browser">
          <div className="demo-browser__bar">
            <span className="demo-browser__dot demo-browser__dot--red" />
            <span className="demo-browser__dot demo-browser__dot--yellow" />
            <span className="demo-browser__dot demo-browser__dot--green" />
            <span className="demo-browser__url">{DEMO_URL[locale]}</span>
            <span className="demo-browser__live">{fr ? "Live" : "Live"}</span>
          </div>

          <div className="demo-browser__body">
            <div
              className="grid md:grid-cols-2 gap-5 sm:gap-6 trial-layout product product__info-wrapper"
            ...
            >
              ...
              <div className="trial-product product__info flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2">Shadow Stripe Collared Soccer Jersey</h3>
                <p className="text-2xl font-bold mb-3">18.12 €</p>
                <p className="text-sm text-zinc-400 mb-4">
                  {fr ? (
                    <>
                      Cliquez <strong className="text-white">Essayer</strong> ci-dessous — aperçu en ~30 s.
                    </>
                  ) : (
                    <>
                      Click <strong className="text-white">Try it on</strong> below — preview in ~30s.
                    </>
                  )}
                </p>
                ...
                <form action="#" className="product-form mt-auto" onSubmit={(e) => e.preventDefault()}>
                  <div className="trial-buy space-y-3">
                    ...
                    <div className="demo-tryon-zone">
                      <span className="demo-tryon-zone__pulse" aria-hidden="true" />
                      <span className="demo-tryon-zone__label">
                        {fr ? "Widget essayage ↓" : "Try-on widget ↓"}
                      </span>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-4 text-xs text-zinc-500">
